  ...
  if (isset($_GET['id_pengeluaran'])) {
    ...
    $data = mysqli_fetch_assoc($result);
      // apabila data tidak ada pada database maka akan dijalankan perintah ini
       if (!count($data)) {
          echo "<script>alert('Data tidak ditemukan pada database');window.location='../pages/pengeluaran.php';</script>";
       }
  } else {
          ...
          <div class="card">
            <div class="card-header pb-0">
              <div class="d-flex align-items-center">
                <p class="mb-0">Edit Pengeluaran</p>
              </div>
            </div>
            <div class="card-body">
              ...
              <div class="row">
                ...
                <form method="post" action="../algoritma/update_peng.php" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="id_pengeluaran" value="<?php echo $data['id_pengeluaran']; ?>" autofocus="" required="" />
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="tanggal" value="<?php echo $data['tanggal']; ?>" required="" />
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="harga_barang" value="<?php echo $data['harga_barang']; ?>" />
                  </div>
              </div>
              <div class="col-md-6">
                  <div class="form-group">
                    <label for="example-text-input" class="form-control-label">Total</label>
                    <input class="form-control" type="text" name="total" value="<?php echo $data['total']; ?>" />
                  </div>
              </div>
              <div class="col-md-6">
                  <div class="form-group">
