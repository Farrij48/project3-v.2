      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm"><a class="opacity-5 text-white" href="javascript:;">Stok Barang</a></li>
            <li class="breadcrumb-item text-sm text-white active" aria-current="page">Upload Barang</li>
          </ol>
          <h6 class="font-weight-bolder text-white mb-0">Upload Barang</h6>
        </nav>
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input class="form-control" type="button" name="status_prod"  />
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
