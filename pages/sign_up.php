    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navigation">
        ...
        <ul class="navbar-nav d-lg-block d-none">
          <li class="nav-item">
            <a href="https://drive.google.com/drive/folders/1zMNNczkfbsUmX97_Or61JXaDV1VEBQEk?usp=share_link" class="btn btn-sm mb-0 me-1 bg-gradient-light">Download Apk</a>
          </li>
        </ul>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5 text-center mx-auto">
            ...
            <p class="text-lead text-white">Sign Up terlebih dahulu dan isi datanya.</p>
          </div>
        </div>
      </div>
    </div>
